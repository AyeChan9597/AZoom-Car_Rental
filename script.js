...
register.addEventListener('mouseover', function() {
    registerIcon.src = 'Image/register.png';
});
        ...
        cars.forEach(car => {
            ...
            carDiv.innerHTML = `
                <div class="details">
                    ...
                    <hr/>
                    <div class="spec1">
                        <p class="detail-text2"><img src="Image/user.png"/> ${car.capacity}</p>
                        <p class="detail-text2"><img src="Image/airCon.png"/>  A/C</p>
                        <p class="detail-text1"><img src="Image/carEngine.png"/> ${car.model}</p>
                        <p class="detail-text2"><img src="Image/carGearEngine.png"/>  ${car.engine}</p>
                        <p class="detail-text2"> <img src="Image/location.png"/> ${car.location} </p>
                    </div>
                        ...
                        <div>
                            <div id = "specification">
                                ...
                                <div class="spec-details">
                                    <p class="detail-text1"><img src="Image/airCon.png"/> A/C</p>
                                    <p class="detail-text1"><img src="Image/carGearEngine.png"/> ${car.engine}</p>
                                    <p class="detail-text1"><img src="Image/user.png"/>  ${car.capacity}</p>
                                    <p class="detail-text1"><img src="Image/carEngine.png"/> ${car.model}</p>
                                    <p class="detail-text1"><img src="Image/carDoor.png"/> ${car.doors}</p>
                                    <p class="detail-text1"><img src="Image/location.png"/> ${car.location}</p>
                                </div>
                                <p>$ ${car.price}/day</p>
                            </div>
                             <div class="desc">
                            ...
                            <div class="services">
                                ...
                                <div class="services-details">
                                    <p>
                                        <img src="Image/check.png" alt="">Free Cancelliation(24h)
                                    </p>
                                    <p>
                                        <img src="Image/check.png" alt="">Covered for damages
                                    </p>
                                    <p>
